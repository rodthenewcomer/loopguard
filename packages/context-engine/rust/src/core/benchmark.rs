...
pub fn format_terminal(b: &ProjectBenchmark) -> String {
    ...
    out.push(format!("  loopguard-ctx Benchmark — {}", b.root));
    out.push(sep.to_string());
...
pub fn format_markdown(b: &ProjectBenchmark) -> String {
    ...
    out.push("# loopguard-ctx Benchmark Report".to_string());
    out.push(String::new());
    ...
    out.push(String::new());
    out.push(format!(
        "*Generated by loopguard-ctx benchmark v{} — https://loopguard.vercel.app*",
