...
pub mod ctx_blame;
pub mod ctx_broadcast;
pub mod ctx_budget;
pub mod ctx_changelog_pkg;
pub mod ctx_commit_msg;
pub mod ctx_compare;
pub mod ctx_compress;
pub mod ctx_context;
pub mod ctx_dedup;
pub mod ctx_delta;
pub mod ctx_diagnostics;
pub mod ctx_diff_apply;
pub mod ctx_discover;
pub mod ctx_docs;
pub mod ctx_expand;
pub mod ctx_facts;
pub mod ctx_facts_graph;
pub mod ctx_fill;
...
pub mod ctx_graph_query;
pub mod ctx_graph_update;
pub mod ctx_handoff;
pub mod ctx_harness;
pub mod ctx_hover;
pub mod ctx_imports;
...
pub mod ctx_pdf;
pub mod ctx_pkg_create;
pub mod ctx_pkg_load;
pub mod ctx_pr_pack;
pub mod ctx_pr_review;
pub mod ctx_predict;
pub mod ctx_proof;
pub mod ctx_quotes;
pub mod ctx_read;
pub mod ctx_refactor;
pub mod ctx_references;
pub mod ctx_rename;
pub mod ctx_report;
...
pub mod ctx_scan;
pub mod ctx_search;
pub mod ctx_search_web;
pub mod ctx_semantic;
pub mod ctx_session;
pub mod ctx_share;
pub mod ctx_shell;
pub mod ctx_similar;
...
impl CrpMode {
    pub fn from_env() -> Self {
        match std::env::var("LOOPGUARD_CTX_CRP_MODE")
            .unwrap_or_default()
            .to_lowercase()
            .as_str()
        {
...
impl Default for LoopguardCtxServer {
    fn default() -> Self {
        Self::new()
    }
}

impl LoopguardCtxServer {
    pub fn new() -> Self {
        let config = crate::core::config::Config::load();

        let interval = std::env::var("LOOPGUARD_CTX_CHECKPOINT_INTERVAL")
            .ok()
            .and_then(|v| v.parse().ok())
            .unwrap_or(config.checkpoint_interval as usize);

        let ttl = std::env::var("LOOPGUARD_CTX_CACHE_TTL")
            .ok()
            .and_then(|v| v.parse().ok())
    ...
    async fn write_mcp_live_stats(&self) {
        ...
        if let Some(dir) = dirs::home_dir().map(|h| h.join(".loopguard-ctx")) {
...
pub fn create_server() -> LoopguardCtxServer {
    LoopguardCtxServer::new()
}
