...
[Pi Coding Agent](https://github.com/badlogic/pi-mono) extension that routes tool output through [loopguard-ctx](https://loopguard.vercel.app) for focused reads and smaller prompts.
