...
When authenticated, session metrics are synced within moments after changes,
periodically in the background, and again at session end. Sync is best-effort
— the extension keeps working locally if the backend is unavailable.
