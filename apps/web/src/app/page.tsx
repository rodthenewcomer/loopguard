  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#071019]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-12 overflow-hidden rounded-[28px] border border-white/10 bg-black/20 backdrop-blur">
              <div className="grid gap-px bg-white/8 sm:grid-cols-4">
                {METRICS.map((metric) => (
                  <div key={metric.label} className="bg-[#08121D] px-5 py-5">
                    <div className="text-3xl font-black tracking-[-0.05em]" style={{ color: metric.tone }}>
                      {metric.value}
                    </div>
                    <div className="mt-2 text-xs uppercase tracking-[0.22em] text-[#4E6B88]">
                      {metric.label}
                    </div>
                  </div>
                ))}
              ...
              <div className="relative overflow-hidden rounded-[36px] border border-white/10 bg-[linear-gradient(160deg,rgba(11,22,36,0.96),rgba(7,16,25,0.92))] shadow-[0_40px_120px_rgba(0,0,0,0.45)]">
                <div className="border-b border-white/8 px-6 py-5">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <div className="text-xs uppercase tracking-[0.28em] text-[#4E6B88]">Live session</div>
                ...
                <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
                  <div className="border-b border-white/8 px-6 py-6 lg:border-b-0 lg:border-r">
                    <div className="mb-5 flex items-center justify-between">
                      ...
                      <div className="text-xs uppercase tracking-[0.22em] text-[#4E6B88]">32 min lost</div>
                    </div>
                  ...
                  <div className="px-6 py-6">
                    <div className="mb-5 flex items-center justify-between">
                      ...
                      <div className="text-xs uppercase tracking-[0.22em] text-[#4E6B88]">7% kept</div>
                    </div>
                    <div className="rounded-[24px] border border-white/8 bg-black/20 p-4">
                      <div className="mb-3 flex items-center gap-2 text-xs uppercase tracking-[0.22em] text-[#4E6B88]">
      ...
      <div className="border-y border-white/8 bg-black/20">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-3 px-6 py-4 text-sm text-[#8095AA]">
          <span className="text-xs uppercase tracking-[0.28em] text-[#4E6B88]">Works with</span>
          {WORKSPACES.map((workspace) => (
            <span
              key={workspace}
              className="rounded-full border border-white/10 px-3 py-1 text-xs font-medium text-[#A5B8CA]"
            >
              {workspace}
            </span>
          ))}
      ...
      <section id="how-it-works" className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        <ScrollReveal className="mb-12 max-w-2xl">
          <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#4E6B88]">How it works</div>
        ...
        <div className="grid gap-10 border-t border-white/8 pt-8 lg:grid-cols-3">
          {SURFACES.map((surface) => (
            <ScrollReveal key={surface.title}>
              <div className="border-l border-white/10 pl-6">
                ...
                >
                  <span className="mr-2 inline-flex">
                    <Icon path={surface.accent === '#F59E0B' ? IC.loop : surface.accent === '#22D3EE' ? IC.copy : IC.shield} size={14} />
                  </span>
                  LoopGuard
                </div>
        ...
        <div className="grid gap-16 lg:grid-cols-[1fr_0.92fr] lg:items-start">
          <ScrollReveal direction="left">
            <div className="overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(9,18,30,0.9),rgba(5,12,20,0.9))]">
              <div className="border-b border-white/8 px-6 py-5">
                <div className="text-xs uppercase tracking-[0.28em] text-[#4E6B88]">What a loop looks like</div>
          ...
          <ScrollReveal direction="right">
            <div>
              <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#4E6B88]">Why it matters</div>
              <h2 className="mt-3 text-4xl font-bold tracking-[-0.05em] text-white sm:text-5xl">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        <div className="grid gap-16 lg:grid-cols-[0.92fr_1fr] lg:items-start">
          <ScrollReveal direction="left">
            <div>
              <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#4E6B88]">Context engine</div>
              <h2 className="mt-3 text-4xl font-bold tracking-[-0.05em] text-white sm:text-5xl">
                Smaller prompts.
                <br />
                Cleaner answers.
          ...
          <ScrollReveal direction="right">
            <div className="overflow-hidden rounded-[32px] border border-white/10 bg-black/20">
              <div className="flex items-center justify-between border-b border-white/8 px-6 py-4">
                <div>
                  <div className="text-xs uppercase tracking-[0.28em] text-[#4E6B88]">Prompt payload</div>
              ...
              <div className="grid gap-px bg-white/8 sm:grid-cols-[0.85fr_1.15fr]">
                <div className="bg-[#08121D] px-6 py-6">
                  <div className="text-xs uppercase tracking-[0.22em] text-[#4E6B88]">Without LoopGuard</div>
                ...
                <div className="bg-[#06111B] px-6 py-6">
                  <div className="text-xs uppercase tracking-[0.22em] text-[#4E6B88]">With LoopGuard</div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        <ScrollReveal className="mb-12 max-w-2xl">
          <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#4E6B88]">Install paths</div>
          <h2 className="mt-3 text-4xl font-bold tracking-[-0.05em] text-white sm:text-5xl">
            Start in the editor.
            <br />
        ...
        <ScrollReveal>
          <div className="mx-auto max-w-5xl overflow-hidden rounded-[36px] border border-white/10 bg-[linear-gradient(160deg,rgba(10,20,32,0.96),rgba(7,16,25,0.9))] px-8 py-10 shadow-[0_35px_100px_rgba(0,0,0,0.35)] sm:px-12">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
              <div>
                <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#4E6B88]">Support the project</div>
                <h2 className="mt-3 text-4xl font-bold tracking-[-0.05em] text-white sm:text-5xl">
          ...
          <div className="grid gap-10 md:grid-cols-[1.3fr_repeat(3,1fr)]">
            ...
            {FOOTER_COLS.map((column) => (
              <div key={column.heading}>
                <div className="text-xs font-semibold uppercase tracking-[0.24em] text-[#4E6B88]">{column.heading}</div>
